...
def AWBM_function(i_day,df,df_SILO_data_cal,C1,C2,C3,A1,A2,A3,BFI,BS_0,Kbase,SS_0,Ksurf,A,CN_P,CN_E):
    ...
    # Calculating storage levels and overflows 
        ...
        df.loc[i_day,'E'] = df_SILO_data_cal[CN_E][i_day] 
        df.loc[i_day,'P'] = df_SILO_data_cal[CN_P][i_day] 
