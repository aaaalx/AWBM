# =============================================================================
# ===== AWBM - Urban Catchment Example (Basic Model)                      =====
# =============================================================================
# ===== Example application of the Australian Water Balance Model (AWBM)  =====
# ===== using a daily timestep. Based on the UQ Lake test model           =====
# ===== prepared as part of the Lake resortation project.                 =====
# =====                                                                   =====
# =============================================================================
...
infile_name = 'MetData-Jan-Mar-1974.csv'     # This input data used for calibartion.
...
A = float(0.26);          # Catchment area [km^2]
